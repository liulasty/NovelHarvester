...
const SCRAPER_TO_SCRIPT_REL = Object.freeze({
  ...
  chengzixs: path.join('gaode', 'chengzixs', 'scrape-chengzixs.js'),
  ddw23: path.join('gaode', 'ddw23', 'scrape-23ddw.js'),
  xncwxw: path.join('gaode', 'xncwxw', 'scrape-xncwxw.js'),
  biquzi: path.join('gaode', 'biquzi', 'scrape-biquzi.js'),
});
